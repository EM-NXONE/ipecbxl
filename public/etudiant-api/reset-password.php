...
api_method('POST');
if (!etu_rate_limit('reset_set', 6, 600)) api_error('Trop de tentatives. Réessaie plus tard.', 429);
...
api_json(['ok' => true, 'message' => 'Mot de passe mis à jour. Tu peux te connecter.']);

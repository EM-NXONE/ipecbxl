      ...
      <div className="mx-auto max-w-3xl px-6 lg:px-10">
        ...
        <div className="space-y-10 text-sm text-muted-foreground leading-relaxed">
          <section>
            ...
            <p>
              Le présent site est édité par l'<strong className="text-cream">Institut Privé des Études Commerciales</strong>, en abrégé <strong className="text-cream">"IPEC"</strong>,

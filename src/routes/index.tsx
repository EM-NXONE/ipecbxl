    ...
    <>
      ...
      <section className="py-24 lg:py-40 border-t border-border/30">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10 mt-24 lg:mt-32">
          <div className="grid md:grid-cols-12 gap-10 items-start p-10 lg:p-14 rounded-sm border border-border/60 bg-card/40 relative overflow-hidden">
            <div className="absolute -top-32 -right-32 w-96 h-96 rounded-full bg-blue/10 blur-3xl pointer-events-none" />

            <div className="md:col-span-3 flex justify-center md:justify-start relative">

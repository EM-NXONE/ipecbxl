          ...
          {specs.map((s, i) => (
            <div key={s.n} className="bg-background p-10 lg:p-16 grid lg:grid-cols-12 gap-10 hover:bg-card/50 transition-colors group">
              ...
              <div className="lg:col-span-5">
                <s.icon className="text-gold mb-6" size={36} strokeWidth={1.5} />
      ...
      <section className="py-20 border-t border-border/30">
        <div className="mx-auto max-w-5xl px-6 lg:px-10 text-center">
          <h2 className="font-display text-4xl md:text-5xl text-cream text-balance">
            Pas encore décidé·e ? <em className="text-gradient-gold not-italic">C'est normal.</em>
          </h2>
          ...
          <Link to="/programmes" className="mt-10 inline-flex items-center gap-2 px-8 py-4 rounded-sm bg-gradient-gold text-ink font-medium shadow-gold hover:opacity-90 transition-opacity">

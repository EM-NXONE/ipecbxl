        ...
        <div className="space-y-10 text-sm text-muted-foreground leading-relaxed">
          ...
          <section>
            ...
            <p>
              ...
              Google reCAPTCHA v3, fourni par Google Ireland Limited.
            </p>
            <ul className="mt-3 space-y-2 list-disc list-inside">
              <li>
                Données transmises à Google : adresse IP, informations sur le navigateur et le
                système d'exploitation, données de comportement sur la page (mouvements souris,
                frappes clavier, durée d'interaction), cookies Google déjà présents le cas échéant.
              </li>
              <li>
                Finalité : distinguer les utilisateurs humains des robots, attribuer un score de
                confiance et bloquer les soumissions jugées frauduleuses.
              </li>
              <li>
                Base légale : intérêt légitime de l'IPEC (art. 6.1.f RGPD) à protéger ses systèmes
                et la qualité des données reçues.
              </li>
              <li>
                Transfert hors UE : Google peut traiter ces données aux États-Unis dans le cadre
                du EU–US Data Privacy Framework.
              </li>
              <li>
                Durée de conservation : définie par Google, conformément à sa politique.
              </li>
            </ul>
            <p className="mt-3">
          ...
          <section>
            ...
            <ul className="mt-3 space-y-2 list-disc list-inside">
              <li>
                Données affichées : prénom, initiale et dernière lettre du nom (ex. « J*N »),
                type de document, programme, année, spécialisation et date d'enregistrement.
                Aucune donnée de contact, financière ou sensible n'est divulguée.
              </li>
              <li>
                Finalité : permettre la vérification d'authenticité tout en limitant la
                divulgation de données personnelles (principe de minimisation, art. 5.1.c RGPD).
              </li>
              <li>
                Base légale : intérêt légitime de l'IPEC et des tiers à pouvoir vérifier
                l'authenticité d'un document, équilibré par le masquage partiel du nom.
              </li>
              <li>
                Information de la personne concernée : lors du dépôt d'une candidature, le
